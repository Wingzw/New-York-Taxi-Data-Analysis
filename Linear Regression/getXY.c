 ...
 * get trip_time from trip_data file and total amount less the tolls amount from trip_fare file
 * parameters:
 ...
 */
void getXY(char **filename_fare, char **filename_data, double *trip_time, double *fee){
...
int main(){
    ...
    getXY(&filename1, &filename2, value1, value2);
